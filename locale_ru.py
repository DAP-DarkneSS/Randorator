...
dict_str = {
    ...
    u"ui_ifrnd": u"Количество цифер после разделителя целой и дробной части.",
    u"ui_ifsrt": u"Сортировка задаётся вводом номеров чисел через пробел, номер определяется положением числа в списке, где первый номер имеет наменьшее значение.\n\nДопускается ввод диапазонов номеров через дефис.\n\n-1 задаёт сортировку от большего к меньшему,\nа 1- — от меньшего к большему."}
